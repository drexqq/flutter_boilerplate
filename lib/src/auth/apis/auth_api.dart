...
import 'package:flutter_boilerplate/services/providers/provider_api.dart';
...
final authApiProvider = Provider((ref) => AuthAPI(ref));

class AuthAPI implements AuthApiProtocol {
  AuthAPI(this._ref);
